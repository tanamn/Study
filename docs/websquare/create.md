...
## 24. GitHub Pages 반영 방법

이 파일을 Repository의 다음 위치에 넣습니다.
...
PowerShell에서 다음과 같이 복사할 수 있습니다.
...
```powershell
git add docs/websquare/create.md
git commit -m "WebSquare 신규 고객 등록 학습 문서 추가"
git push origin main
```

Pages 배포가 완료되면 다음 주소로 접근할 수 있습니다.

```text
https://tanamn.github.io/Study/websquare/create/
```
